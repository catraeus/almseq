...
CfgStrings::CfgStrings(const char *theLang, int buildNo) {
  ...
  strcpy(tStr, "There is no open file right now."     );   strsFileCloseNone  = new char[strlen(tStr) + 1]; strcpy(strsFileCloseNone,  tStr);
	...
	strcpy(en_PROG_NAME                , "hematite");
	strcpy(en_MAIN_TITLE               , "hematite Audio File Analyzer");
	strcpy(en_CARD_CONFIG_TITLE        , "hematite - Configure Sound Card");
	strcpy(en_CARD_CONFIG_ST_CHG_CARD  , "Card changed:  ");
	strcpy(en_ABOUT_TITLE              , "About hematite");
	strcpy(en_ABOUT_PROG               , "hematite Audio File Analyzer");
	strcpy(en_ABOUT_COMPANY            , "Catraeus");
	strcpy(en_ABOUT_COPYRIGHT          , "Copyright © 2010 - 2019; Catraeus and Duncan Gray");
	...
	strcpy(fr_PROG_NAME                , "hematite");
	strcpy(fr_MAIN_TITLE               , "hematite analyzeur de dosier d'audio");
	strcpy(fr_CARD_CONFIG_TITLE        , "hematite - Configurer carte son");
	strcpy(fr_CARD_CONFIG_ST_CHG_CARD  , "Carte changé:  ");
	strcpy(fr_ABOUT_TITLE              , "À hematite");
	strcpy(fr_ABOUT_PROG               , "hematite analyzeur de dosier d'audio");
	strcpy(fr_ABOUT_COMPANY            , "Catraeus");
	strcpy(fr_ABOUT_COPYRIGHT          , "Copyright © 2010 - 2019; Catraeus et Duncan Gray");
	...
	strcpy(zz_PROG_NAME                , "hematite");
	strcpy(zz_MAIN_TITLE               , "hematite Audio File Analyzer");
	strcpy(zz_CARD_CONFIG_TITLE        , "hematite - Configure Sound Card");
	strcpy(zz_CARD_CONFIG_ST_CHG_CARD  , "Card changed:  ");
	strcpy(zz_ABOUT_TITLE              , "About hematite");
	strcpy(zz_ABOUT_PROG               , "hematite Audio File Analyzer");
	strcpy(zz_ABOUT_COMPANY            , "Catraeus");
	strcpy(zz_ABOUT_COPYRIGHT          , "Copyright © 2010 - 2019; Catraeus and Duncan Gray");
